...
public class VaultPlaceholderExpansion extends PlaceholderExpansion {
    ...
    public VaultPlaceholderExpansion(Plugin plugin, Economy economy, Messages messages) {
        this.plugin = plugin;
    ...
    public String onRequest(OfflinePlayer player, String params) {
        ...
        switch (key) {
            ...
            default:
                ...
                // support ecobalance<number>dp e.g., ecobalance2dp
                if (key.startsWith("ecobalance") && key.endsWith("dp")) {
                    ...
                    try {
                        ...
                        ensureAccountForRequest(player, player);
                        double bal = getBalanceForRequest(player, player);
                        String s = String.format(Locale.ROOT, "%" + "." + dp + "f", bal);
                        return s;
